    ...
    <div class="page-scroll-wrapper" style="overflow-x: hidden;">
        <div class="container section-pad">
            <div class="section-header text-center">
                <h1 class="section-title">IberScroll</h1>
            </div>
                                ...
                                <div class="card-info">
                                    ...
                                    <p class="text-secondary" style="font-size: 0.9rem; margin-bottom: 0.75rem;">
                                        <svg viewBox="0 0 24 24" width="14" height="14"
                                            style="display:inline;vertical-align:middle;margin-right:4px" fill="none"
                                    ...
                                    <a href="{{ $p['url'] }}" class="btn btn-outline btn-sm"
                                        style="margin-top: 1rem; width: 100%">Ver detalles</a>
                                </div>
                            </div>
                        @endforeach
                    </div>
